...
- Name: critical-flows.spec.ts >> Critical business flows >> A4) User edits rejected gasto — all fields changeable — resubmits
- Location: tests/e2e/critical-flows.spec.ts:608:7
