...
- Name: critical-flows.spec.ts >> Critical business flows >> 3) Offline → sync keeps consistency (single expense, no duplicates)
- Location: tests/e2e/critical-flows.spec.ts:484:7
...
Locator: getByText('Offline sync expense')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Offline sync expense')
