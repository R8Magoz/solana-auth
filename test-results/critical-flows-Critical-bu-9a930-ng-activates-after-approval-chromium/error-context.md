...
- Name: critical-flows.spec.ts >> Critical business flows >> B2) Submit factura with A pagar — payment tracking activates after approval
- Location: tests/e2e/critical-flows.spec.ts:663:7
