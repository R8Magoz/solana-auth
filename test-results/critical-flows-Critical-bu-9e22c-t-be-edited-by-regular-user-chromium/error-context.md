...
- Name: critical-flows.spec.ts >> Critical business flows >> A5) Approved gasto cannot be edited by regular user
- Location: tests/e2e/critical-flows.spec.ts:632:7
...
Call log:
  - waiting for locator('input[type="email"]')
    - locator resolved to <input value="" type="email" class="auth-inp" autocomplete="email" placeholder="Introduce tu correo"/>
    - fill("admin@solana.test")
