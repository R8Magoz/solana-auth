...
- Name: critical-flows.spec.ts >> Critical business flows >> B1) Submit factura without A pagar — paymentStatus is paid on creation
- Location: tests/e2e/critical-flows.spec.ts:650:7
